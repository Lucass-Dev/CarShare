...
class TripFormModel
{
     ...
     * @return int|false Returns trip ID on success, false on failure
     */
        ...
        try {
            $stmt = $this->db->prepare("
                INSERT INTO carpoolings (
                    ...
                    status, start_id, end_id, pets_allowed, smoker_allowed, luggage_allowed
                )
                VALUES (
                    :provider_id, :start_date, :price, :available_places,
                    :status, :start_id, :end_id, :pets_allowed, :smoker_allowed, :luggage_allowed
            ...
            $success = $stmt->execute([
                ...
                ':start_date' => $data['start_date'],  // Date du trajet saisie par l'utilisateur
                ...
                ':smoker_allowed' => $data['smoker_allowed'] ?? 0,
                ':luggage_allowed' => $data['luggage_allowed'] ?? 0
            ]);
