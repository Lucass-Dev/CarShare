// User and carpooling selection for rating page
document.addEventListener('DOMContentLoaded', function() {
    ...
    userSelect.addEventListener('change', function() {
        ...
        fetch('/CarShare/index.php?action=rating_get_carpoolings&user_id=' + userId)
            .then(response => {
                if (!response.ok) {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (userId && carpoolingId) {
            window.location.href = '/CarShare/index.php?action=rating&user_id=' + userId + '&carpooling_id=' + carpoolingId;
        }
    });
});
