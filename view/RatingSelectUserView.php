<section class="main container">
    <section class="rating">
      <h1 class="rating__title">Sélectionnez un utilisateur à noter</h1>
      ...
      <div class="rating__card">
        <form id="select-user-form" style="padding: 20px;">
          <div class="form__group" style="margin-bottom: 20px; position:relative;">
            <label class="form__label" for="user-search">Rechercher un utilisateur</label>
            <input 
                type="text" 
                id="user-search" 
            ...
            <!-- Results dropdown -->
            <div id="search-results" style="display:none; position:absolute; background:white; border:1px solid #ccc; max-height:300px; overflow-y:auto; width:100%; z-index:1000; border-radius:4px; box-shadow:0 2px 8px rgba(0,0,0,0.1); margin-top:2px;"></div>
          </div>
          ...
          <div class="rating__stars-row">
            <button type="submit" class="btn btn--primary rating__submit" disabled id="continue-btn">
              Continuer
            </button>
          </div>
        </form>
...
<script>
// Dynamic user search for rating
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (selectedUserId) {
            ...
            window.location.href = url('index.php?action=rating&user_id=' + selectedUserId);
        }
    });
});
</script>
