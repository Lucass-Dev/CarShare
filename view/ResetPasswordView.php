...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
                ...
                <div class="error-message">
                    ...
                    <div>
                        ...
                        <?php if (strpos($error, 'expiré') !== false || strpos($error, 'invalide') !== false): ?>
                            <br><br>
                            <a href="<?= url('index.php?action=forgot_password') ?>" style="color: #8f9bff; font-weight: bold;">Faire une nouvelle demande</a>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <a href="<?= url('index.php?action=login') ?>" class="back-link">← Retour à la connexion</a>
        </div>
    </div>
</body>
</html>
