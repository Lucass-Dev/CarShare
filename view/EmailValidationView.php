...
<body>
    ...
    <div class="container">
        <?php if ($success): ?>
            ...
            <a href="<?= url('index.php?action=home') ?>" class="button">Accéder à mon compte</a>
        <?php else: ?>
            ...
            <a href="<?= url('index.php?action=register') ?>" class="button">Réessayer l'inscription</a>
            <br>
            <a href="<?= url('index.php?action=home') ?>" class="secondary-link">Retour à l'accueil</a>
        <?php endif; ?>
    </div>
</body>
</html>
